...
public class BackendApplication {
	...
	public static void main(String[] args) {
		...
		if (System.getProperty("JPA_DDL_AUTO") == null) System.setProperty("JPA_DDL_AUTO", "update");
		if (System.getProperty("JPA_SHOW_SQL") == null) System.setProperty("JPA_SHOW_SQL", "true");
		if (System.getProperty("SERVER_PORT") == null) System.setProperty("SERVER_PORT", "8080");
